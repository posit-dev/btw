...
[`btw`](https://posit-dev.github.io/btw/reference/btw.md)`(``"{dplyr}"``, ``?``dplyr``::`[`across`](https://dplyr.tidyverse.org/reference/across.html)`)`\
\
`# Combine multiple pieces of context`\
[`btw`](https://posit-dev.github.io/btw/reference/btw.md)`(``mtcars``, ``"{dplyr}"``, ``"How do I calculate the mean mpg by cylinder?"``)`
...
`chat``$``register_tools``(`[`btw_tools`](https://posit-dev.github.io/btw/reference/btw_tools.md)`(``)``)`\
\
...
`chat``$``register_tools``(`[`btw_tools`](https://posit-dev.github.io/btw/reference/btw_tools.md)`(`[`c`](https://rdrr.io/r/base/c.html)`(``"docs"``, ``"files"``)``)``)`
