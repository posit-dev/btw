...
This outlines how to propose a change to btw. For a detailed discussion
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("posit-dev/btw", fork = TRUE)`.
...
Conduct](https://posit-dev.github.io/btw/dev/CODE_OF_CONDUCT.md). By
