...
btw reads configuration – context files (`btw.md`, `AGENTS.md`,
`CLAUDE.md`), skills, and btw-style agent definitions – from a
combination of project-level and user-level (global) locations. This
page describes where btw looks for each type of configuration and in
