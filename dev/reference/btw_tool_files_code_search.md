...
#> ℹ Indexing files in /tmp/Rtmpc9ISVf/file39f43174288e for code search
#> ✔ Indexing files in /tmp/Rtmpc9ISVf/file39f43174288e for code search [334ms]
#> 
#> <btw::BtwToolResult>
#>  @ value  :'data.frame': 1 obs. of  5 variables:
#>  .. $ filename     : chr "state_names_1.md"
#>  .. $ size         : 'fs_bytes' num 219
#>  .. $ last_modified: POSIXct, format: "2025-12-08 18:49:39"
