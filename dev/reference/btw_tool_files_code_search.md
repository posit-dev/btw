...
#> ℹ Indexing files in /tmp/RtmpXgb4BV/file241b24a41ca1 for code search
#> ✔ Indexing files in /tmp/RtmpXgb4BV/file241b24a41ca1 for code search [909ms]
#> 
#> <btw::BtwToolResult>
#>  @ value  :'data.frame': 1 obs. of  5 variables:
#>  .. $ filename     : chr "state_names_1.md"
#>  .. $ size         : 'fs_bytes' num 219
#>  .. $ last_modified: POSIXct, format: "2025-11-13 15:30:12"
