...
#> ℹ Indexing files in /tmp/RtmpSSf2qJ/file225d4ceab7f8 for code search
#> ✔ Indexing files in /tmp/RtmpSSf2qJ/file225d4ceab7f8 for code search [523ms]
#> 
#> <btw::BtwToolResult>
#>  @ value  :'data.frame': 1 obs. of  5 variables:
#>  .. $ filename     : chr "state_names_1.md"
#>  .. $ size         : 'fs_bytes' num 219
#>  .. $ last_modified: POSIXct, format: "2026-01-12 17:55:58"
