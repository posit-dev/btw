...
#> 
#> pkgsearch::pkg_search("network visualization", size = 1)
#> Found 3511 packages matching `network visualization`, showing 1 result.
#> 
#> | package | title | version | date | url | downloads_last_month |
#> |---------|-------|---------|------|-----|----------------------|
#> | visNetwork | Network Visualization using 'vis.js' Library | 2.1.4 | 2025-09-04 | https://datastorm-open.github.io/visNetwork/ | 77,630 |
btw(
