...
#> ℹ Indexing files in /tmp/RtmpBfNu2W/file226358ef2ea0 for code search
#> ✔ Indexing files in /tmp/RtmpBfNu2W/file226358ef2ea0 for code search [345ms]
#> 
#> <btw::BtwToolResult>
#>  @ value  :'data.frame': 1 obs. of  5 variables:
#>  .. $ filename     : chr "state_names_1.md"
#>  .. $ size         : 'fs_bytes' num 219
#>  .. $ last_modified: POSIXct, format: "2026-01-14 15:22:34"
