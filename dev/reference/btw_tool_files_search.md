...
#> ℹ Indexing files in /tmp/RtmpqKdLjP/file222053115e3e for code search
#> duckdb keeps downloaded extensions and secrets in a temporary directory:
#> ℹ /tmp/RtmpqKdLjP/duckdb
...
#> ✔ Indexing files in /tmp/RtmpqKdLjP/file222053115e3e for code search [442ms]
#> 
#> <btw::BtwToolResult>
#>  @ value  :'data.frame': 1 obs. of  5 variables:
#>  .. $ filename     : chr "state_names_1.md"
#>  .. $ size         : 'fs_bytes' num 219
#>  .. $ last_modified: POSIXct, format: "2026-09-07 02:00:30"
