...
Because
[`shinychat::chat_server()`](https://posit-dev.github.io/shinychat/r/reference/chat_app.html)
must be called from within a Shiny app, this function can't be
demonstrated with a runnable example. Inside your app's server function:
