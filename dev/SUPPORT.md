...
Thanks for using btw! Before filing an issue, there are a few places to
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/posit-dev/btw/issues/new).
...
requests](https://github.com/posit-dev/btw/issues) to make sure the bug
