...
\
[`btw`](https://posit-dev.github.io/btw/dev/reference/btw.md)`(``mtcars``, ``"{dplyr}"``, ``?``dplyr``::`[`across`](https://dplyr.tidyverse.org/reference/across.html)`)`\
...
`chat``$``register_tools``(`[`btw_tools`](https://posit-dev.github.io/btw/dev/reference/btw_tools.md)`(``"docs"``, ``"env"``)``)``  ``# Only doc and environment tools`
...
\
`chat`` ``<-`` `[`btw_client`](https://posit-dev.github.io/btw/dev/reference/btw_client.md)`(``mtcars``)``  ``# Starts with mtcars in context`\
`chat``$``chat``(``"Summarize this data"``)`\
\
[`btw_app`](https://posit-dev.github.io/btw/dev/reference/btw_client.md)`(``)``  ``# Launches Shiny chat interface`
...
[`btw`](https://posit-dev.github.io/btw/dev/reference/btw.md)`(``mtcars``)`\
\
`# Or start a chat`\
`chat`` ``<-`` `[`btw_client`](https://posit-dev.github.io/btw/dev/reference/btw_client.md)`(``)`\
