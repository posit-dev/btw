...
1.  **User-facing API** -
    [`btw()`](https://posit-dev.github.io/btw/reference/btw.md) function
    accepts any R objects, help topics, file paths, or special commands
    (e.g., `"@platform_info"`, `"{dplyr}"`) and assembles them into
    LLM-ready context
...
[`btw_this()`](https://posit-dev.github.io/btw/reference/btw_this.md) is
the extensible backend that powers
[`btw()`](https://posit-dev.github.io/btw/reference/btw.md):
