...
Tools are grouped by capability: - **docs** - Package documentation,
...
**search** - Search CRAN packages - **session** - Platform info,
installed packages - **web** - Read web pages as markdown
