...
#> ℹ Indexing files in /tmp/RtmptQkQ4k/file20ff5eaf9a05 for code search
#> duckdb keeps downloaded extensions and secrets in a temporary directory:
#> ℹ /tmp/RtmptQkQ4k/duckdb
...
#> ✔ Indexing files in /tmp/RtmptQkQ4k/file20ff5eaf9a05 for code search [558ms]
#> 
#> <btw::BtwToolResult>
#>  @ value  :'data.frame': 1 obs. of  5 variables:
#>  .. $ filename     : chr "state_names_1.md"
#>  .. $ size         : 'fs_bytes' num 219
#>  .. $ last_modified: POSIXct, format: "2026-08-05 14:45:20"
