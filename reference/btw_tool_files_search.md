...
#> ℹ Indexing files in /tmp/RtmpiIXAtw/file21cf9bfc165 for code search
#> duckdb keeps downloaded extensions and secrets in a temporary directory:
#> ℹ /tmp/RtmpiIXAtw/duckdb
...
#> ✔ Indexing files in /tmp/RtmpiIXAtw/file21cf9bfc165 for code search [250ms]
#> 
#> <btw::BtwToolResult>
#>  @ value  :'data.frame': 1 obs. of  5 variables:
#>  .. $ filename     : chr "state_names_1.md"
#>  .. $ size         : 'fs_bytes' num 219
#>  .. $ last_modified: POSIXct, format: "2026-08-05 14:49:09"
