...
file](https://posit-dev.github.io/btw/reference/use_btw_md.md) under the
`options` section.
...
In your [btw.md
file](https://posit-dev.github.io/btw/reference/use_btw_md.md), you can
explicitly enable the tool by naming it in the tools option
