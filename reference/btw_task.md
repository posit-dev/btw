...
text using [`btw()`](https://posit-dev.github.io/btw/reference/btw.md).
This context is appended to the system prompt:
...
#> # <ellmer::ToolDef> btw_task_file24693debb250(prompt)
#> # @name: btw_task_file24693debb250
...
#>     }
#> }
#> <bytecode: 0x55c8f8a9bfd0>
#> <environment: 0x55c8f8bac508>
