...
* User-level config locations are now consistent across skills, agents, and `btw.md` discovery. Skills installed with btw <= 1.2.0 are still discovered for backwards compatibility (#182).
